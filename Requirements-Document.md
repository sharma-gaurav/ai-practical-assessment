...
[1\. What This Is](#bookmark=id.y2zod3ji348j)

[2\. Who Takes Part](#bookmark=id.7la4ksdu36ay)

[3\. Time and Effort](#bookmark=id.e5wp448ohrz6)

[4\. What You Get Out of It](#bookmark=id.vpotf5jxb8dy)

[5\. How the Exercise is Structured](#bookmark=id.wj74qrem3tfd)

[Part A: AI Workflow Foundation](#bookmark=id.22eqzo7ckvte)

[Part B: Full-Stack Mini Project](#bookmark=id.shsz9fopw5je)

[Submission Templates](#bookmark=id.ty9cuefcbrff)

[Tool-Specific Expectations](#bookmark=id.fxzauv6cjdql)

[What Counts as Complete](#bookmark=id.br3ormd750ll)

[How to Take Part](#bookmark=id.u3sz9s66aik8)

[What Good Looks Like](#bookmark=id.dctdk8nl6x8a)

[Your Growth Path](#bookmark=id.ddqu9cyrfagx)

[Summary](#bookmark=id.pubsnzx9gnn6)
...
**Implementation Assumptions/Suggestions (added for AEC team):**

1. This is applicable for all positions SE to TA.  
2. Evaluation will be done by code pulse tool.  
3. **Most Important:** The solution is at the discretion of the developer. The given problem can be solved in multiple ways. We are not looking for a specific solution; instead, the intention is to make sure the developer utilises every skill learned during the C0 compliance course.  
4. AEM Development is required to solve the problem using the following topology: 1 Author \+ 1 Publisher \+ 1 Dispatcher.   
5. DO NOT try to solve problems like data sync across multiple publisher environments (or keep it as a stretch goal if you want to).  
6. Solution should be built on AEM. If you are not familiar with AEM, you can use any FE, BE, and database.  
7. For an AEM solution, use the latest AEMaaCS SDK.  
8. Dev can utilise adobe official skills  
9. Dev can utilise spec-driven workflow (WF). Ensure you read the requirement document first.  
10. Prompt records are mandatory.  
11. For user management, you can utilise AEM's OOTB user management. How you want to persist Ticket and Comments is completely up to you.
...
ai-practical-assessment/  
  ...
  test-strategy.md  
  src/   tests/  
  ~~**database/**~~ **(NOT relevant for AEM team push content in ui.content)**  
